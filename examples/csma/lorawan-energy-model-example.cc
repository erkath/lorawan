...
//     LogComponentEnable ("BasicEnergySource", LOG_LEVEL_ALL);
    ...
    //    Names::Add("/Names/EnergySource0", sources.Get(0));
    //    Names::Add("/Names/EnergySource1", sources.Get(1));
    //    Names::Add("/Names/EnergySource1", sources.Get(1));
    ...
    fileHelper.ConfigureFile("without-csma-battery-level", FileAggregator::SPACE_SEPARATED);
...
//    fileHelper.WriteProbe("ns3::DoubleProbe", "/Names/EnergySource1/RemainingEnergy", "Output");
